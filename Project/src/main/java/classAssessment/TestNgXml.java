...
public class TestNgXml {
	@Test
	public void loginToLogout() throws InterruptedException {
		...
		driver.findElement(By.id("email_create")).sendKeys("alkfssdfghsdjiaf@mail.com");
		Thread.sleep(2000);
		...
		//Sign in
		driver.findElement(By.id("email")).sendKeys("alkfsiaf@mail.com");
		driver.findElement(By.id("passwd")).sendKeys("Passw0rd$123");
